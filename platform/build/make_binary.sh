...
if test "$2" = "osx"; then
	...
	APR_LIB=libapr-1.$SHARED_LIB_SUFFIX
	APR_UTIL_LIB=libaprutil-1.$SHARED_LIB_SUFFIX
else
	...
	APR_LIB=libapr-1.$SHARED_LIB_SUFFIX.0
	APR_UTIL_LIB=libaprutil-1.$SHARED_LIB_SUFFIX.0
fi
