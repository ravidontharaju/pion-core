...
var gridLayout = [{
	rows: [[
		{ name: 'Field Name', styles: '', width: 20, 
			editor: dojox.grid.editors.Input},
		{ name: 'Term', styles: '', 
			editor: dojox.grid.editors.Dijit, editorClass: "dijit.form.FilteringSelect", 
			editorProps: {store: term_store, searchAttr: "id", keyAttr: "id" }, width: 20},
		{ name: 'Start Char', width: 5, styles: 'text-align: center;', 
			editor: dojox.grid.editors.Input},
		{ name: 'End Char', width: 5, styles: 'text-align: center;', 
			editor: dojox.grid.editors.Input},
		{ name: 'Delete', styles: 'align: center;', width: 4, 
